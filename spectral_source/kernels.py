...
from spectral_source.Galerkin_transformer import SimpleTransformerEncoderLayer, SimpleTransformerEncoderLastLayer
from spectral_source.Attentional_IE_solver import interval_function
